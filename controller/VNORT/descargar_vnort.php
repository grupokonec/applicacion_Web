...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['tipo_informe'])) {
        ...
        if ($conn->connect_error) {
         ...
         // Conexión a la base de datos del vicidial
        ...
        switch ($tipo_seleccionado) {
            case "reporte_semanal":
                ...
                break;
            case "pagos":
                $nombre_archivo = "Informe_Pagos_vnort.csv";
            ...
            case "bot":
                ...
                case "cartera_totales":
                    $nombre_archivo = "Cartera_totales_vnort.csv";
                    $sql = "SELECT * FROM cartera_totales";
                    $result = $conn->query($sql);
                    break;
                case "bloqueados":
                     $nombre_archivo = "Bloqueados_vnort.csv";
                     $sql = "SELECT * FROM bloqueados";
                     $result = $conn->query($sql);
                    break;
                case "lista_negra":
                     $nombre_archivo = "Lista_negra_vnort.csv";
                     $sql = "SELECT * FROM lista_negra";
                     $result = $conn->query($sql);
                    break;
                case "lista_negra_mail":
                     $nombre_archivo = "Lista_negra_mail_vnort.csv";
                     $sql = "SELECT * FROM lista_negra_email";
                     $result = $conn->query($sql);
                    break;
                case "asignados":
                    $nombre_archivo = "asignados_vnort.csv";
                    $sql = "SELECT * FROM asignacion_ejecutivos";
                    $result = $conn->query($sql);
                    break;
                case "recupero":
                    $nombre_archivo = "Recupero_ejecutivo_vnort.csv";
