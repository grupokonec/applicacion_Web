    ...
    if (isset($_POST['tipo_informe'])) {
        ...
        switch ($tipo_seleccionado) {
            case "reporte_semanal":
                ...
                break;
            case "pagos":
                $nombre_archivo = "Informe_Pagos_vsur.csv";
            ...
            case "bot":
                ...
                case "cartera_totales":
                    $nombre_archivo = "Cartera_totales_vsur.csv";
                    $sql = "SELECT * FROM cartera_totales";
                    $result = $conn->query($sql);
                    break;
                case "bloqueados":
                     $nombre_archivo = "Bloqueados_vsur.csv";
                     $sql = "SELECT * FROM bloqueados";
                     $result = $conn->query($sql);
                    break;
                case "lista_negra":
                     $nombre_archivo = "Lista_negra_vsur.csv";
                     $sql = "SELECT * FROM lista_negra";
                     $result = $conn->query($sql);
                    break;
                case "lista_negra_mail":
                     $nombre_archivo = "Lista_negra_mail_vsur.csv";
                     $sql = "SELECT * FROM lista_negra_email";
                     $result = $conn->query($sql);
                    break;
                case "asignados":
                    $nombre_archivo = "asignados_vsur.csv";
                    $sql = "SELECT * FROM asignacion_ejecutivos";
                    $result = $conn->query($sql);
                    break;
                case "recupero":
                    $nombre_archivo = "Recupero_ejecutivo_vsur.csv";
