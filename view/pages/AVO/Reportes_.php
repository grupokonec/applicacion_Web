        ...
        <div class="row grid-margin">
          <div class="col-12">
            <div class="alert alert-success" role="alert">
              Informes <strong>Autopista Vespucio Oriente </strong> </div>
            ...
            <form id="informeForm" action="../controller/AVO/descargar_avo.php" method="post">
              ...
              <select id="tipo_informe" name="tipo_informe" class="custom-select" required>
                ...
                <option value="cartera">Cartera Totales</option>
