<div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Autopista Vespucio Oriente</h4>
        <div class="row grid-margin">
          <div class="col-12">
            <div class="alert alert-success" role="alert">
              <strong>Nota:</strong> Tener en cuenta que el RUT a ingresar debe ser sin dígito verificador.
            </div>

            <h>Bloquear RUT</h>
            <form action="../controller/AVO/bloq_avo.php" method="post">
              <?php
            ...
            <form action="../controller/AVO/bloq_fono_avo.php" method="post">
              <?php
              date_default_timezone_set('America/Santiago');
              $fcha = date("Y-m-d H:i:s"); ?>
              <div class="form-group row">
            ...
            <h>Bloquear Email</h>
            <form action="../controller/AVO/bloq_mail_avo.php" method="post">
              <?php
              date_default_timezone_set('America/Santiago');
              $fcha = date("Y-m-d H:i:s"); ?>
              <div class="form-group row">
