                  ...
                  <div class="row grid-margin">
                    <div class="col-12">
                      <div class="alert alert-success" role="alert">
                        Cuadratura de <strong>Costanera Norte</strong> </div>
                      ...
                      <table class="table table-bordered">
                        <thead>
                          <tr>
                            ...
                            <th style="text-align: center; font-size:80%;">Comprobantes</th>
                        ...
                        while ($row = $result->fetch_assoc()) {
                          ...
                          echo "<td style='text-align: center; font-size:80%;'>" . number_format($row['Comprobantes'], 0, '.', '.') . "</td>";
