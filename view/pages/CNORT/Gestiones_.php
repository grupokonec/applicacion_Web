                    ...
                    <div class="form-group row">
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Ingrese el RUT" id="rut" name="rut"
                                    required>
                                <div class="input-group-append">
                                    <button type="button" class="btn btn-warning" data-toggle="popover"
                                        title="Información del RUT"
...
<script>
    function buscarCliente() {
        ...
        xhr.open("POST", "pages/CNORT/components/gestion.php", true);
